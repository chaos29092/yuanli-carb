        ...
        <div class="grid-container grid-parent">
            <nav class="breadcrumbs grid-75 push-25 tablet-grid-75 tablet-push-25 mobile-grid-100">
                <ul>
                    ...
                    <li><a href="/contact/{{$page->slug}}">{{title_case($page->name)}}</a></li>
                </ul>
            </nav>
        </div>
    </div>
                ...
                <div class="csc-default">
                    ...
                    <div class="csc-mailform3448">
                        <form action="/inquiry_submit" enctype="multipart/form-data" method="post">
                            ...
                            <input type="hidden" name="subject" value="{{$page->name}}">
                            <script>
                            ...
                            <ol>
                                ...
                                <li class="csc-form-287 csc-form-element csc-form-element-textline">
                                    <label for="field-287">Phone/WhatApp</label>
                ...
                <nav class="nav">
                    <ul>
                        @foreach($pages as $the_page)
                            <li @if(ends_with(url()->current(),$the_page->slug)) class="current" @endif><a href="/contact/{{$the_page->slug}}">{{title_case($the_page->name)}}</a></li>
                        @endforeach
                    </ul>
                </nav>
